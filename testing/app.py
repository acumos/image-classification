...
def transform(mime_type, image_binary):
    ...
    if app.rich_return:
        ...
        for r in zip(pred[Formatter.COL_NAME_CLASS], pred[Formatter.COL_NAME_PREDICTION], range(len(pred))):
            retObj['classes'].append({'class':r[0], 'rank':r[2], 'score':r[1] })
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rich_return', dest='rich_return', action='store_true', help='output rich JSON instead of direct prediction')
    ...
    app.app.rich_return = pargs.rich_return     # helps dictate output format
